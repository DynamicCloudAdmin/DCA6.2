...
Import-Module Az.Aks -RequiredVersion 5.3.0 -Global
...
Import-Module Az.Automation -RequiredVersion 1.9.0 -Global
Import-Module Az.Batch -RequiredVersion 3.3.0 -Global
...
Import-Module Az.Compute -RequiredVersion 5.4.0 -Global
...
Import-Module Az.ContainerRegistry -RequiredVersion 3.0.1 -Global
Import-Module Az.CosmosDB -RequiredVersion 1.9.0 -Global
Import-Module Az.DataBoxEdge -RequiredVersion 1.1.0 -Global
Import-Module Az.Databricks -RequiredVersion 1.4.0 -Global
Import-Module Az.DataFactory -RequiredVersion 1.16.12 -Global
...
Import-Module Az.DataProtection -RequiredVersion 1.1.0 -Global
...
Import-Module Az.EventHub -RequiredVersion 3.2.1 -Global
...
Import-Module Az.KeyVault -RequiredVersion 4.9.1 -Global
...
Import-Module Az.Network -RequiredVersion 5.4.0 -Global
...
Import-Module Az.RecoveryServices -RequiredVersion 6.2.0 -Global
...
Import-Module Az.Synapse -RequiredVersion 2.2.0 -Global
Import-Module Az.TrafficManager -RequiredVersion 1.2.0 -Global
Import-Module Az.Websites -RequiredVersion 2.12.1 -Global
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCZAk3WIsIPfrtY
# moxmz3U7VLfa0f24x7h887rOu4MnW6CCDYEwggX/MIID56ADAgECAhMzAAACzI61
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQglreF7iH7
# vX0aAJO/HselxEZRVAbg9VMDyrFR/yzSOSUwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQAhvc2CScK21R+1fI8lBTqpjioxBAWX0u+7bxf3BJgL
# T6TOQhb+pQF3ig7j4oe66AWDgc1gthDjqVlDtmuqitsgSfbstJASja/xH2acPKZM
# NxGM/qnhpkJxLThnjzBWr6rxBWoaitMPsfhqlEKjkX0hO3Bqbzj2+VrhjeXFfbyk
# IkHeu7w8tFsMLinnMiVyEZw4dOU6Ka0Uk17fhpQJKQ1/zCZEk5GovUXQELs8SKOA
# TuH7AXLEC1qUlcSx6WSADDDWgRZvrF4DklIb/fd2D3STH+lTJZ8GlZO+X/JrsgC/
# uHaw2KwolDBVp4EEGio/0kjyNWqt/e+1BgTQVKT9h2r3oYIXDDCCFwgGCisGAQQB
# gjcDAwExghb4MIIW9AYJKoZIhvcNAQcCoIIW5TCCFuECAQMxDzANBglghkgBZQME
# AgEFADCCAVUGCyqGSIb3DQEJEAEEoIIBRASCAUAwggE8AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEINu2Z+IaspiVv1tQslsOtxUzSm5I4ffOFOn/5RBy
# TcIcAgZjxosPSl0YEzIwMjMwMjAzMTA0NTM0LjQwN1owBIACAfSggdSkgdEwgc4x
...
# AzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgULk6JUehxfSRT9xsjOhm
# yH6fz3EsKdAHKb3AM6VUxDAwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCD5
...
# AJ1kdBR4aVlyUPb7n797hTymFOlogGNYORbOw4jbBYUAvY2rkBu20lGlYViEuV1Y
# MLjq5Jqqco4SUG6LI3p9c6qcD+OSSUQtBGbBs2YmFad5DXs68sVzniRamqExZhdY
# pR6Nm9aw6gb8Ego+x37fneegXHe+qk2EfjhWEQV4HpRjsMsbcRAkxbd1zgNLVekl
# RG5UJDgEEZPE+tyvYwlhiFmaVSWPAYO/v4DGZL5+FQTDHklb9dxseDTbpUmTT/Ap
# sTevyyrVF+oOkjeeLmOMEEW9q32ZgykcHPAvhYnM9YPiuUwAURLtHFrTfz/o601s
# 731VkD0+VQv8xOhtwd+EVDVFNlEq05dCuHNFZWWIUq24v15H2sKqRX9+xYVExXKu
# vVtWbJGepx3/mK5DjTDov78VxRejftc5xxUOsGXV3PNMH4LgL41xsvr91GnNKQEu
# Iq+O6s1McHd4De7u0y5Rco6Heg43TvPxDnc5bwrg1Pnh4t9duEyLKLrwkNXl27Uk
# lKFix3T7syXuIfK3PtvyaPakIGJZ8fY3QCCkT2Cl9LkuE3+tURXs9gV6j0kUhWQW
# X3Rz5ENgQ4Ra7eX6BpJNzhukguTHI7R8G2A0QSAoMp6+l5TXWDuRnw1XWbZbYndt
# +3vOsm/WRp+aYVnDOSmXf+G/BelCFiKVngj6pW9wySuq
